  ...
  return (
    <View style={styles.container}>
      <Image style={{
        ...
        require('../assets/Page2_b/eye.png')
      } />
      ...
      <View style={styles.inputUS}>
        <Image style={{
          ...
          require('../assets/Page2_b/user.png')
        } />
      ...
      <View style={styles.inputPass}>
        <Image style={{
          ...
          require('../assets/Page2_b/lock.png')
        } />
      ...
      <View style={{
        ...
        <Image
          ...
          source={
            require('../assets/Page2_b/wifi.png')
          } />
        <Image
          style={{
            width: 70,
